document.addEventListener("DOMContentLoaded", () => {
  ...
  const translations = {
    en: {
      ...
      "versione": "This site was created by Lorenzo Bergamini as a personal portfolio. Version: 1.0.0 Last updated: July 2025 This site is not official: it was created exclusively for personal use and educational purposes."
    ...
    it: {
      ...
      "versione":"Questo sito è stato creato da Lorenzo Bergamini come portfolio personale. Versione: 1.0.0 Ultimo aggiornamento: Luglio 2025 Questo sito non è ufficiale: è stato realizzato esclusivamente per uso personale e a scopo didattico."
    }
  };
  ...
  form.addEventListener("submit", (event) => {
    ...
    response.innerHTML = `
      <div style="
        ...
        font-weight: bold;
        max-width: 300px;">
        <img src="check.png" alt="Successo" style="width: 24px; height: 24px;" />
